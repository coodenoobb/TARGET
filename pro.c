...
{
    printf("\n\t\t\t\t\t\t\t1. View total sale \n");
    printf("\t\t\t\t\t\t\t2. Add new item in the order menu\n");
    printf("\t\t\t\t\t\t\t3. Delete item from the order menu\n");
...
{
    printf("\n                                 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
    printf("                                                         RESTAURANT WOOKBOOK\n");
    printf("                                +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n\n");
    printf("\t\t\t\t\t\t\t Enter 1 for Employee : \n");
...
int main()
{
    heada = createadmin(heada, 1, "Chicken Biryani", 150);
    heada = createadmin(heada, 2, "Panner Handi", 200);
    heada = createadmin(heada, 3, "Thai Noodles", 150);
    heada = createadmin(heada, 4, "Chicken Tikka", 180);
    heada = createadmin(heada, 5, "Egg Roll", 80);
    heada = createadmin(heada, 6, "Cold Drink", 50);
    heada = createadmin(heada, 7, "Ice Cream", 50);
    while (1)
    {
        mainnenu();
        int choice;
